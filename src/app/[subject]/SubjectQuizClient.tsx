        ...
        <div className="max-w-5xl mx-auto space-y-10 pb-20">
            ...
            <div className="flex items-center justify-between">
                ...
                {activeTab !== "overview" || viewMode !== "selection" ? (
                    <button 
                        ...
                        className="text-xs font-black uppercase tracking-widest text-primary bg-primary/10 px-4 py-2 rounded-xl border border-primary/20 hover:bg-primary/20 transition-all"
                    >
                        Reset Selection
                    </button>
                ) : null}
            ...
            <header className="space-y-4 text-center">
                <div className="space-y-2">
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black font-headline text-on-surface tracking-tight leading-tight pt-2">
                        {data.title}
                    </h1>
                </div>
                ...
                <div className="flex justify-center pt-4">
                    <button
                        ...
                        className={`flex items-center justify-center gap-2 px-8 py-3 font-black text-xs uppercase tracking-widest rounded-2xl transition-all shadow-sm border group ${activeTab === "history" ? "bg-primary text-on-primary border-primary shadow-lg shadow-primary/20" : "bg-surface-container-lowest text-on-surface border-outline-variant/20 hover:bg-surface-container"}`}
                    >
                    ...
                    {viewMode === "selection" ? (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <button
                                ...
                                className="group relative aspect-[4/5] bg-surface-container-lowest border-2 border-outline-variant/10 rounded-[2.5rem] p-8 flex flex-col items-start text-left hover:border-primary/40 hover:bg-surface-container transition-all hover-lift shadow-sm hover:shadow-2xl hover:shadow-primary/5"
                            >
                                ...
                                <h3 className="text-3xl font-black font-headline text-on-surface mb-3 tracking-tight group-hover:text-primary transition-colors">Practice</h3>
                                ...
                                <div className="absolute top-6 right-6 opacity-5 font-black text-6xl select-none group-hover:opacity-10 transition-opacity">01</div>
                            </button>

                            {/* Block 2: Concept Builder */}
                            <button
                                onClick={() => setViewMode("ai")}
                                className="group relative aspect-[4/5] bg-gradient-to-br from-purple-500/[0.03] to-indigo-500/[0.03] bg-surface-container-lowest border-2 border-outline-variant/10 rounded-[2.5rem] p-8 flex flex-col items-start text-left hover:border-purple-500/40 hover:bg-surface-container transition-all hover-lift shadow-sm hover:shadow-2xl hover:shadow-purple-500/5"
                            >
                                ...
                                <h3 className="text-3xl font-black font-headline text-on-surface mb-3 tracking-tight group-hover:text-purple-600 transition-colors">Concept Builder</h3>
                                <p className="text-sm text-on-surface-variant font-medium leading-relaxed opacity-70">
                                ...
                                <div className="absolute top-6 right-6 opacity-5 font-black text-6xl select-none group-hover:opacity-10 transition-opacity">02</div>
                            </button>

                            {/* Block 3: PYQs and Mocks */}
                            <button
                                onClick={() => setViewMode("exam")}
                                className="group relative aspect-[4/5] bg-surface-container-lowest border-2 border-outline-variant/10 rounded-[2.5rem] p-8 flex flex-col items-start text-left hover:border-amber-500/40 hover:bg-surface-container transition-all hover-lift shadow-sm hover:shadow-2xl hover:shadow-amber-500/5"
                            >
                                ...
                                <h3 className="text-3xl font-black font-headline text-on-surface mb-3 tracking-tight group-hover:text-amber-600 transition-colors">PYQs & MOCK</h3>
                                <p className="text-sm text-on-surface-variant font-medium leading-relaxed opacity-70">
                                ...
                                <div className="absolute top-6 right-6 opacity-5 font-black text-6xl select-none group-hover:opacity-10 transition-opacity">03</div>
                            </button>
                        </div>
                    ...
                    {viewMode === "selection" && (
                        <div className="flex flex-col items-center justify-center gap-6 pt-12">
                            <Link
                                ...
                                className="group flex flex-col items-center gap-2 p-6 rounded-[2rem] hover:bg-surface-container-high transition-all"
                            >
                                <p className="text-sm font-bold text-on-surface-variant">NOT Prepared for subject?</p>
                                <div className="flex items-center gap-2 px-6 py-3 bg-on-surface text-surface font-black text-xs uppercase tracking-[0.2em] rounded-xl group-hover:scale-105 transition-transform">
                                    <BookOpen className="w-4 h-4" /> Access Notes
                                </div>
                            </Link>
                        </div>
                    )}
