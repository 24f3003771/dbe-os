            ...
            <header className="space-y-2 text-center">
                <div className="space-y-1">
                    <div className="flex items-center justify-center gap-2">
                        <span className="px-2 py-0.5 bg-primary/10 text-primary font-mono text-[10px] tracking-widest font-bold rounded border border-primary/20 shadow-sm">
                            {data.id}
                        </span>
                    </div>
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black font-headline text-on-surface tracking-tight leading-tight">
                        {data.title}
                    </h1>
                </div>
                ...
                <div className="flex justify-center pt-2">
                    <button
                        ...
                        className={`flex items-center justify-center gap-2 px-6 py-2 font-black text-[10px] uppercase tracking-widest rounded-xl transition-all shadow-sm border group ${activeTab === "history" ? "bg-primary text-on-primary border-primary shadow-lg shadow-primary/20" : "bg-surface-container-lowest text-on-surface border-outline-variant/20 hover:bg-surface-container"}`}
                    >
                    ...
                    {viewMode === "selection" && (
                        <div className="flex flex-col items-center justify-center gap-4 pt-8">
                            <Link
                                ...
                                className="group flex flex-col items-center gap-1 p-4 rounded-[2rem] hover:bg-surface-container-high transition-all"
                            >
                                <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">NOT Prepared for subject?</p>
                                <div className="flex items-center gap-2 px-6 py-2 bg-on-surface text-surface font-black text-[10px] uppercase tracking-[0.2em] rounded-lg group-hover:scale-105 transition-transform">
                                    <BookOpen className="w-3 h-3" /> Access Notes
                                </div>
                            </Link>
                        </div>
                    )}
