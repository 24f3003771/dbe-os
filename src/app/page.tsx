  ...
  return (
    <div className="flex flex-col gap-6 max-w-[1400px] mx-auto pb-20 px-4 md:px-8 xl:px-12 pt-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {/* Left Column (4 columns) - Calendar, To-Do, Focus Mode */}
          <div className="lg:col-span-4 flex flex-col gap-6">
              ...
              {/* Focus Mode */}
              <div className="bg-white rounded-[2.5rem] p-8 border border-stone-100 shadow-sm flex flex-col flex-1 min-h-[350px]">
                  ...
                  <div className="flex justify-center flex-1 items-center relative py-8">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                          <span className="text-2xl font-black text-stone-900 tracking-tight">01:45:22</span>
                          <span className="text-[10px] font-bold text-stone-400 uppercase tracking-widest mt-1">Remaining</span>
                      </div>
                  </div>
          ...
          {/* Right Column (8 columns) - Hero Banner, Control Center */}
          <div className="lg:col-span-8 flex flex-col gap-6">
              
              {/* Hero Banner (Integrated with Leaderboard) */}
              <div className="bg-gradient-to-br from-[#FFF0EB] to-[#FFE5DC] rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden border border-white/50 shadow-sm flex flex-col md:flex-row gap-8 min-h-[460px]">
              ...
              <div className="bg-[#FAF9F6] rounded-[2rem] p-6 border border-stone-100 shadow-sm flex flex-col">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                      {/* Switches */}
                      <div onClick={() => toggleControl('darkMode')} className="bg-white p-3 md:p-4 rounded-xl border border-stone-100 shadow-sm flex items-center justify-between cursor-pointer hover:bg-stone-50 transition-colors">
                          <div className="flex items-center gap-3">
                      ...
                      <div onClick={() => toggleControl('focusMode')} className="bg-white p-3 md:p-4 rounded-xl border border-stone-100 shadow-sm flex items-center justify-between cursor-pointer hover:bg-stone-50 transition-colors">
                          <div className="flex items-center gap-3">
                      ...
                      <div onClick={() => toggleControl('strictMode')} className="bg-white p-3 md:p-4 rounded-xl border border-stone-100 shadow-sm flex items-center justify-between cursor-pointer hover:bg-stone-50 transition-colors">
                          <div className="flex items-center gap-3">
                      ...
                      <div onClick={() => toggleControl('notifications')} className="bg-white p-3 md:p-4 rounded-xl border border-stone-100 shadow-sm flex items-center justify-between cursor-pointer hover:bg-stone-50 transition-colors">
                          <div className="flex items-center gap-3">
                      ...
                      <div onClick={() => toggleControl('performanceMode')} className="bg-white p-3 md:p-4 rounded-xl border border-stone-100 shadow-sm flex items-center justify-between cursor-pointer hover:bg-stone-50 transition-colors">
                          <div className="flex items-center gap-3">
                              <Zap className={`w-4 h-4 ${controls.performanceMode ? 'text-indigo-600' : 'text-stone-400'}`} />
                              <span className="text-[11px] font-black text-stone-700">Performance</span>
                          </div>
                      ...
                      <div className="bg-white p-3 md:p-4 rounded-xl border border-stone-100 shadow-sm flex items-center justify-between cursor-pointer hover:bg-stone-50 transition-colors">
                          <div className="flex items-center gap-3">
                              <Palette className="w-4 h-4 text-rose-500" />
                              <span className="text-[11px] font-black text-stone-700">Theme</span>
                          </div>
